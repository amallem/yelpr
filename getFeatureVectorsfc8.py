...
path_to_data = '/Users/mallem/Downloads/'
path_to_caffe = '/Users/mallem/dev/caffe/'
...
#layer takes the values of fc6,fc7,fc8
def get_features(images, layer = 'fc8'):
...
trainfeatures = h5py.File(path_to_data+'train_image_fc8features.h5','w')
...
for i in range(0, trainingimagecount, interval_size): 
    ...
    features = get_features(images, layer='fc8')
    count = i+features.shape[0]
    trainf= h5py.File(path_to_data+'train_image_fc8features.h5','r+')
...
testfeatures = h5py.File(path_to_data+'test_image_fc8features.h5','w')
...
for i in range(0, testingimagecount, interval_size): 
    ...
    features = extract_features(images, layer='fc8')
    count = i+features.shape[0]
    
    testf= h5py.File(path_to_data+'test_image_fc8features.h5','r+')
