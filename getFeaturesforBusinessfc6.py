...
f = h5py.File(path_to_data+'train_image_fc6features.h5','r')
...
with open(path_to_data+"train_biz_fc6features.csv",'w') as f:  
...
with open(path_to_data+"test_biz_fc6features.csv",'w') as f:  
    df.to_csv(f, index=False)
