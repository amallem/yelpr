...
def get_features(images, layer = 'fc6'):
...
trainfeatures = h5py.File(path_to_data+'train_image_fc6features.h5','w')
...
for i in range(0, trainingimagecount, interval_size): 
    ...
    features = get_features(images, layer='fc6')
    count = i+features.shape[0]
    trainf= h5py.File(path_to_data+'train_image_fc6features.h5','r+')
...
testfeatures = h5py.File(path_to_data+'test_image_fc6features.h5','w')
...
for i in range(0, testingimagecount, interval_size): 
    ...
    testf= h5py.File(path_to_data+'test_image_fc6features.h5','r+')
