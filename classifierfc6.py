...
train_features = pd.read_csv(path_to_data+"train_biz_fc6features.csv")
test_features  = pd.read_csv(path_to_data+"test_biz_fc6features.csv")
...
tdf  = pd.read_csv(path_to_data+"test_biz_fc6features.csv")
...
with open(path_to_data+"submission_fc6.csv",'w') as file67:
